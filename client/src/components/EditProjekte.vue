    ...
    <div>
        <form id="addForm" @submit.prevent="submit"  class="pb-2 mb-3 mr-3">
            <div class="form-group" :class="{'form-group--error': $v.intro_title.$error}">
                <label for="intro_titleInput">Titel:</label>
            ...
            <div class="error" v-if="!$v.intro_title.minLength">Author must have at least {{$v.author.$params.minLength.min}} letters.</div>
